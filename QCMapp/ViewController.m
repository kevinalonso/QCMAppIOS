...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
        ...
        for(UserQcm* itemUser in resUsers){
            if([loginEditText.text isEqualToString:itemUser.login]
               && [passwordEditText.text isEqualToString:itemUser.password]){
                ...
                loginGet = itemUser.login;
                idUserGet = itemUser.idUserQcm;
                found = true;
            }
        }
    ...
    welcomeViewController.segueLogin = loginGet;
    welcomeViewController.segueId = idUserGet;
